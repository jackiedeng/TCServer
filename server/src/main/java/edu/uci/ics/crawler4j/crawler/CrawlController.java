                    ...
                    try {
                        synchronized (waitingLock) {
                            ...
                            while (true) {
                                ...
                                LogUtil.biz.info("爬虫线程总数:{} 工作中:{} 崩溃中:{} 等待中:{} 已爬取数量:{}",
                                        threads.size(),workThreadTotal,deadTotal,threads.size()-workThreadTotal-deadTotal
                                , FileSaveService.imgSaveTotalCount);
